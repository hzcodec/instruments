...
print 'Widht:',windowWidth,'  -  Height:',windowHeight

# set fullscreen
screen  = pygame.display.set_mode((windowWidth, windowHeight), pygame.FULLSCREEN, 32)
...
exInstrument     = Instrument(screen, '../pic/small_green_needle.png', FIRST_INSTRUMENT_MID_POINT,  5, 1.5, 0.8)
...
exInstrument.set_needle_position(degAngle)
...
while 1:
    ...
    exInstrument.instrument_update(exInstrumentdegAngle)
    ...
    for event in pygame.event.get():
        ...
        # trig the instruments
            ...
            if event.key == pygame.K_1:
                ...
                exInstrument.set_flag(True)
                inputData = 1.1
                exData = 4.5
                firstInstrumentdegAngle = -20*inputData + 220
                exInstrumentdegAngle = -20*exData + 220
